...
package com.israelbatista.bookstoremanager.exception;
...
@ControllerAdvice
public class BookstoreManagerExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(
        ...
        exception.getBindingResult().getGlobalErrors().forEach(
                globalErrors ->
                        errors.add("Field " + globalErrors.getObjectName()
