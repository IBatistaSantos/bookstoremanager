...
public class BookControllerTest {
    ...
    @Test
    void whenDELETEIsCalledWithValidBookIdThenStatusNoContentShouldBeInformed() throws Exception {
    ...
    @Test
    void whenPUTTIsCalledThenOkStatusShouldBeReturned() throws Exception {
